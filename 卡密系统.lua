...
TextBox.TextSize = 14
TextBox.PlaceholderText = "卡密获取qq：1057315887"
...
TextButton.MouseButton1Click:Connect(function()
    if TextBox.Text == "皮空脚本牛逼" then
        Message.Text = "验证成功，正在加载脚本..."
        Message.TextColor3 = Color3.fromRGB(0, 255, 0)
        wait(1)
        ScreenGui:Destroy()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/smalldesikon/vv/b2bd45f6287c91035ecf608a6cc6e931901db660/%E4%B8%80%5B%E6%AD%A3%E5%9C%A8%E4%BD%BF%E7%94%A8%5D.txt"))()
        executeScript()
    else
        attempts = attempts + 1
